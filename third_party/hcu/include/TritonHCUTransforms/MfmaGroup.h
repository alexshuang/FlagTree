#ifndef TRITON_DIALECT_TRITONHCUGPU_TRANSFORMS_MFMAGROUP_H_
#define TRITON_DIALECT_TRITONHCUGPU_TRANSFORMS_MFMAGROUP_H_
...
//===----------------------------------------------------------------------===//
// HCUGPU MFMA instruction selection utilities
//===----------------------------------------------------------------------===//
...
struct MfmaInsnGroupSelectKeyInfo
  ...
  static unsigned getHashValue(const MfmaInsnGroupSelectKey &key) {
    auto dimMNHash = llvm::detail::combineHashValue(key.mDim, key.nDim);
    auto dimHash = llvm::detail::combineHashValue(dimMNHash, key.kDim);
...
#endif // TRITON_DIALECT_TRITONHCUGPU_TRANSFORMS_MFMAGROUP_H_
