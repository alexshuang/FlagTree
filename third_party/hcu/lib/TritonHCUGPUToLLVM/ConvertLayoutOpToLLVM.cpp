...
public:
  ...
  matchAndRewrite(triton::gpu::LocalLoadOp op, OpAdaptor adaptor,
    ...
    if (isa<DotOperandEncodingAttr>(dstLayout) &&
        isa<HCUMfmaEncodingAttr, HCUWmmaEncodingAttr>(
...
private:
  ...
  Value lowerSharedToDotOperandMMA(
    ...
    if (!isOuter &&
        isa<HCUMfmaEncodingAttr, HCUWmmaEncodingAttr>(dopOpParent)) {
      auto sharedToDotConvert = isa<HCUMfmaEncodingAttr>(dopOpParent)
...
public:
  ...
  matchAndRewrite(triton::gpu::ConvertLayoutOp op, OpAdaptor adaptor,
    ...
    if (isa<HCUMfmaEncodingAttr>(srcLayout) &&
