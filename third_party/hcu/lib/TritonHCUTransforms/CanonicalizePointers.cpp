...
class TritonHCUGPUCanonicalizePointersPass
    : public TritonHCUGPUCanonicalizePointersBase<
          TritonHCUGPUCanonicalizePointersPass> {
public:
  TritonHCUGPUCanonicalizePointersPass() = default;
...
std::unique_ptr<Pass> mlir::createTritonHCUGPUCanonicalizePointersPass() {
  return std::make_unique<TritonHCUGPUCanonicalizePointersPass>();
}
