#include "TritonHCUTransforms/MfmaGroup.h"
...
auto getMfmaInsnGroupAttrMap = []() -> const MfmaInsnGroupMap & {
  static MfmaInsnGroupMap MfmaInsnMap{
      ...
      {{16, 16, 0, MfmaTypeId::Fp32TyId, 2},
       {16, 16, 8, 2, ROCDL::mmac_f32_16x16x8tf32::getOperationName()}},
      ...
      {{16, 16, 32, MfmaTypeId::Fp16TyId, 2},
       {16, 16, 32, 4, ROCDL::mmac_f32_16x16x16f16::getOperationName()}},
      {{16, 16, 32, MfmaTypeId::Bf16TyId, 2},
       {16, 16, 32, 4, ROCDL::mmac_f32_16x16x16bf16::getOperationName()}},
      {{16, 64, 0, MfmaTypeId::Fp16TyId, 2},
       {16, 64, 32, 4, ROCDL::mmac_f32_16x16x16f16::getOperationName()}},
      {{16, 64, 0, MfmaTypeId::Bf16TyId, 2},
       {16, 64, 32, 4, ROCDL::mmac_f32_16x16x16bf16::getOperationName()}},
      {{32, 32, 0, MfmaTypeId::Fp16TyId, 2},
       {32, 32, 16, 4, ROCDL::mmac_f32_16x16x16f16::getOperationName()}},
      {{32, 32, 0, MfmaTypeId::Bf16TyId, 2},
       {32, 32, 16, 4, ROCDL::mmac_f32_16x16x16bf16::getOperationName()}},
      {{16, 32, 0, MfmaTypeId::Fp16TyId, 2},
       {16, 32, 16, 4, ROCDL::mmac_f32_16x16x16f16::getOperationName()}},
      {{16, 32, 0, MfmaTypeId::Bf16TyId, 2},
       {16, 32, 16, 4, ROCDL::mmac_f32_16x16x16bf16::getOperationName()}},
      {{16, 16, 0, MfmaTypeId::I8TyId, 2},
       {16, 16, 32, 8, ROCDL::mmac_i32_16x16x32i8::getOperationName()}},
      {{16, 64, 0, MfmaTypeId::I8TyId, 2},
       {16, 64, 64, 8, ROCDL::mmac_i32_16x16x32i8::getOperationName()}},
      {{16, 16, 64, MfmaTypeId::I8TyId, 2},
       {16, 16, 64, 8, ROCDL::mmac_i32_16x16x32i8::getOperationName()}},
      {{16, 32, 0, MfmaTypeId::I8TyId, 2},
       {16, 32, 32, 8, ROCDL::mmac_i32_16x16x32i8::getOperationName()}},
      {{32, 32, 0, MfmaTypeId::I8TyId, 2},
       {32, 32, 32, 8, ROCDL::mmac_i32_16x16x32i8::getOperationName()}},
      {{16, 16, 0, MfmaTypeId::I8TyId, 2},
       {16, 16, 32, 8, ROCDL::mmac_i32_16x16x32u8::getOperationName()}}};
  return MfmaInsnMap;
};
