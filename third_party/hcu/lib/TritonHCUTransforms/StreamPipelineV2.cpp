...
#define DEBUG_TYPE "tritonhcugpu-stream-pipeline-v2"
...
namespace {
struct PipelinePass : public TritonHCUGPUStreamPipelineV2Base<PipelinePass> {
...
std::unique_ptr<Pass>
mlir::createTritonHCUGPUStreamPipelineV2Pass(int numStages) {
