...
def mxgemm_tdm_pipelined_kernel(a_ptr, b_ptr, c_ptr, a_scale, b_scale, M, N, K, stride_am, stride_ak, stride_bk,
    ...
    WMMA_LAYOUT: gl.constexpr = gl.hcu.HCUWMMALayout(3, transposed=True, warps_per_cta=[2, 2],
                                                     instr_shape=[16, 16, 128], tiles_per_warp=tiles_per_warp)
    WMMA_LAYOUT_PACKED: gl.constexpr = gl.hcu.HCUWMMALayout(3, transposed=True, warps_per_cta=[2, 2],
