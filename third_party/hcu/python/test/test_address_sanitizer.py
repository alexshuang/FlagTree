...
def test_address_sanitizer():
    ...
    os.environ["HCU_PYTORCH_NO_CUDA_MEMORY_CACHING"] = "1"
    ...
    # https://llvm.org/docs/HCUGPUUsage.html#target-features
    # https://rocm.docs.hcu.com/en/docs-6.1.0/conceptual/gpu-memory.html
    os.environ["HSA_XNACK"] = "1"

    # Disable buffer ops given it has builtin support for out of bound access.
    os.environ["HCUGCN_USE_BUFFER_OPS"] = "0"
