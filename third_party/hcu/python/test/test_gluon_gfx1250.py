...
def gemm_kernel(a_ptr, b_ptr, c_ptr,  #
    ...
    WMMA_LAYOUT: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(3, True, [2, 2], [16, 16, INSTR_SHAPE_K])
...
def gemm_async_pipelined_kernel(a_ptr, b_ptr, c_ptr,  #
    ...
    BLOCKED_LAYOUT: ttgl.constexpr = ttgl.BlockedLayout([1, 8], [4, 8], [4, 1], [1, 0])
    WMMA_LAYOUT: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(3, True, [2, 2], [16, 16, 32])
...
def test_hcu_wmma_scaled(M, N, K, a_type, b_type):
    ...
    class Layout:
        ...
        def __init__(self, a_type, b_type, scale_nonk, scale_k):
            ...
            wmma_layout = ttgl.hcu.HCUWMMALayout(version=3, transposed=True, warps_per_cta=[2, 2],
                                                 instr_shape=[16, 16, 128])
            wmma_layout_packed = ttgl.hcu.HCUWMMALayout(version=3, transposed=True, warps_per_cta=[2, 2],
...
def test_hcu_wmma_scaled_tdm(M, N, K, mxfp_type, hasScale):
    ...
    def scaled_wmma_tdm_gluon_kernel(a_base, stride_am, stride_ak, a_scale, b_base, stride_bk, stride_bn, b_scale, out,
        ...
        wmma_layout: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(version=3, transposed=True, warps_per_cta=[2, 2],
                                                             instr_shape=[16, 16, 128])
        wmma_layout_packed: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(version=3, transposed=True, warps_per_cta=[2, 2],
                                                                    instr_shape=[16, 16, 64])
...
def mxgemm_kernel(a_ptr, b_ptr, c_ptr, a_scale, b_scale, M, N, K, stride_am, stride_ak, stride_bk, stride_bn, stride_cm,
    ...
    WMMA_LAYOUT: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(3, transposed=True, warps_per_cta=[2, 2],
                                                         instr_shape=[16, 16, 128])
    WMMA_LAYOUT_PACKED: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(3, transposed=True, warps_per_cta=[2, 2],
                                                                instr_shape=[16, 16, 64])
...
def scaled_wmma_scale_preshuffle(a_base, stride_am, stride_ak, a_scale, b_base, stride_bk, stride_bn, b_scale, out,
    ...
    wmma_layout: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(version=3, transposed=TRANSPOSED_WMMA, warps_per_cta=[2, 2],
                                                         instr_shape=[16, 16, 128], tiles_per_warp=tiles_per_warp)
    wmma_layout_packed: ttgl.constexpr = ttgl.hcu.HCUWMMALayout(version=3, transposed=TRANSPOSED_WMMA,
