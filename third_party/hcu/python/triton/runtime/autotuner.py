...
class Autotuner(KernelInterface):
    ...
    def __init__(
        ...
        """
        if not configs:
            self.configs = [Config({}, num_warps=4, num_stages=2, num_ctas=1, num_ldmatrixes=0, enable_mmacfuse=0)]
        else:
...
class Config:
    ...
    def __init__(self, kwargs, num_warps=4, num_stages=2, num_ctas=1, num_ldmatrixes=0, enable_mmacfuse=0, maxnreg=None,
        ...
        self.enable_mmacfuse = enable_mmacfuse
        ...
        return {
            **self.kwargs, **{
                ...
                for (k, v) in (
                    ...
                    ("num_ldmatrixes", self.num_ldmatrixes),
                    ("enable_mmacfuse", self.enable_mmacfuse),
    ...
    def __str__(self):
        ...
        res.append(f"num_ldmatrixes: {self.num_ldmatrixes}")
        res.append(f"enable_mmacfuse: {self.enable_mmacfuse}")
