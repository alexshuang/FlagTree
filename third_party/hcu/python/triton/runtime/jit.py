...
class JITFunction(KernelInterface[T]):
    ...
    def _call_hook(
        ...
        repr = f"{name}[num_warps={options.num_warps}, num_ctas={options.num_ctas}, num_stages={options.num_stages}, num_ldmatrixes={options.num_ldmatrixes}, enable_mmacfuse={options.enable_mmacfuse}, reorder_instr={options.reorder_instr}, enable_fp_fusion={options.enable_fp_fusion}]({arg_reprs})"
        ...
        kwargs = {
            ...
            'reorder_instr': options.reorder_instr,
            'num_ldmatrixes': options.num_ldmatrixes,
            'enable_mmacfuse': options.enable_mmacfuse,
